...
const PropertyDetails = () => {
  ...
  return (
    <Box
      ...
      width="fit-content"
    >
      <Typography fontSize={15} fontWeight={700} color="#11142d">Details</Typography>
      <Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row'}} gap={4}>
        <Box flex={1} maxWidth={764}>
          ...
          <Box mt="15px">
            ...
            <Stack direction="row" justifyContent="space-between" flexWrap="wrap" alignItems="center">
              <Typography fontSize={22} fontWeight={600} color="#11142d" textTransform='capitalize'>{propertyDetails.propertyTitle}</Typography>
